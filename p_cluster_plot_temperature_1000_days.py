...
dfh=read_csv(input_dir+'p_cluster_sites(>1000days).csv')
...
plt.title("the site"+str(index_1000[s])+" within 1 kilometer in the coordinates of 43.4503,-65.4467 ")
plt.ylim(0,15)
plt.ylabel(u"Mean temperature (\u2103)")
plt.xlabel('Year')
plt.savefig(save_dir+str(index_1000[s])+"p_cluster_site_ temperature.png")
plt.show()