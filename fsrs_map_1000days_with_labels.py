...
a.set_title('Longterm sites (>1000 days)',fontsize=20)#with consistent depths
my_map.drawparallels(np.arange(40,80,0.5),labels=[1,0,0,1])
my_map.drawmeridians(np.arange(-180,180,0.5),labels=[1,1,0,1])
plt.savefig(save_dir+'compare_getfsrs_map_1000_days',dpi=200)#_good_depth 
plt.show()
#