...
df_fsrs_1000=read_csv(input_dir+'p_cluster_sites(>1000days).csv')   #fsrs_sites(>some days).py
fig = plt.figure()
...
my_map.drawparallels(np.arange(40,80,3),labels=[0,0,0,1])
my_map.drawmeridians(np.arange(-180,180,3),labels=[1,1,0,1])
plt.savefig(save_dir+'compare_p_cluster_map(all sites,>1 year,> 1000 days)',dpi=200) 
plt.show()
